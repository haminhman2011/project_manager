...
public class MainTestData extends AppCompatActivity {
...
//        wst.execute(new String[] { "http://demo.cloudteam.vn:8080/cocobay_manager/api/get-ticket-detail?ticketNumber=518944&staffId=3&agentId=3"});
    }
    ...
    public class SendPostRequest extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                postDataParams.put("ticketNumber", "518944");

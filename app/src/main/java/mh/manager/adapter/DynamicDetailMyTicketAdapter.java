...
public class DynamicDetailMyTicketAdapter extends ArrayAdapter<ModelDynamicDetailMyTicket> {

    public FormatFont formatFont;

    private Activity activity;

    public DynamicDetailMyTicketAdapter(Activity activity, int resource,ArrayList<ModelDynamicDetailMyTicket> listData) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(vi == null){
            vi = inflater.inflate(R.layout.item_dynamic_detail_myticket, parent, false);
        }
        ModelDynamicDetailMyTicket data = getItem(position);
        llLeft = (LinearLayout)vi.findViewById(R.id.llDynamicLeft);
        llRight = (LinearLayout)vi.findViewById(R.id.llDynamicRight);

        // add text view
        TextView tv = new TextView(activity);
        tv.setId(R.id.tvLabelDetailMyTicket);
        ...
        ed.setId(R.id.edtNameDetailMyTicket);
